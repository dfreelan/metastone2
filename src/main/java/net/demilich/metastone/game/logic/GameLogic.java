...
public class GameLogic implements Cloneable {
    ...
    public void afterCardPlayed(int playerId, CardReference cardReference) {
        ...
        if(card==null)
            System.err.println("could not find card " + cardReference.getCardName() + " " + cardReference.getLocation() + " " + cardReference + "\n " + context);
    ...
    /**
     * Checks all player minions and weapons for destroyed actors and runs their
     * deathrattle.
     */
     ...
     * @param defaultValue The value returned if no occurrence of the attribute
     * is found
    ...
    public void receiveCard(int playerId, Card card) {
        ...
        if (hand.getCount() < MAX_HAND_CARDS && !this.rolloutActive) {
