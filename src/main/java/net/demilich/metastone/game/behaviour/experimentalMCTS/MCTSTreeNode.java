...
public class MCTSTreeNode {
    ...
    private final boolean rerollEvents;
    GameAction action;

    public MCTSTreeNode(GameContext simulation, double exploreFactor, boolean rerollEvents) {
        this.context = simulation;
        this.exploreFactor = exploreFactor;
        this.rerollEvents = rerollEvents;
        if(this.rerollEvents){
    ...
    private MCTSTreeNode(MCTSTreeNode select) {
        ...
        rerollEvents = select.rerollEvents;
...
public void applyAction() {
    ...
    public void expand(int playerID) {
        ...
        for (GameAction action : actions) {
            MCTSTreeNode newNode = new MCTSTreeNode(context, exploreFactor,rerollEvents);
