...
public class HumanDebugBehaviour extends HumanBehaviour implements IActionSelectionListener {
    ...
    public GameAction requestAction(GameContext context, Player player, List<GameAction> validActions) {
        ...
        System.err.println("action was" + selectedAction);
