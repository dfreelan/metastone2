...
public class FlatMCTS extends Behaviour {
    ...
    public FlatMCTS(int numRollouts, int numTrees, double exploreFactor) {
    ...
    public GameAction requestAction(GameContext context, Player player, List<GameAction> validActions) {
        ...
        for (int i = 0; i < gameForest.length; i++) {
            ...
            gameForest[i] = new MCTSTree(numRollouts / numTrees, validActions, temp, exploreFactor);
